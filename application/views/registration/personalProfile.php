...
<hr>
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<small class="form-text text-muted">Please enter the valid URL of website</small>
			</div>
...
<center>
<small class="form-text text-muted">2 of 7  Steps</small>
<progress value="2" max="7" class="mb-3"></progress>
</center>
</div>
